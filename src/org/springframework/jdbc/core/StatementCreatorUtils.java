...
public abstract class StatementCreatorUtils {
    ...
    public static final String IGNORE_GETPARAMETERTYPE_PROPERTY_NAME = "spring.jdbc.getParameter.ignore";
    ...
    private static void setValue(PreparedStatement ps, int paramIndex, int sqlType,
        ...
        if (inValue instanceof SqlTypeValue) {
            ...
            ((SqlVale) inValue).setValue(ps, paramIndex);
        }
        else if (sqlType == Types.VARCHAR || sqlType == Types.LONGNVARCHAR) {
